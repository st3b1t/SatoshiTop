...
Block.prototype = Object.create(canvas.prototype);

Block.prototype.calcSize = function() {
  this.canvasSize = {width: this.width-2, height: this.height};
};

Block.prototype.setData = function(bar) {
...
Block.prototype.getOptionsPrototype = function() {
  return  {  barWidth: 1
    ,  barSpacing: 1
    ,  xOffset: 1
    ,  maxHeight: 1
