...
//DEBUG to generate test/*.json files
/*const si = require('systeminformation');
const out = await si.processes()*/
/*await bitcoin.rpc.connect(opts);
//const bi = await bitcoin.rpc.blockchaininfo();
//const out = await bitcoin.rpc.lastblocks(bi.blockchaininfo.blocks)
const out = await bitcoin.rpc.mempoolinfo()
