...
module.exports = {
  init: async opts => {
    ...
    const cpu = grid.set(0, 0, 3, 5, line, {
      label: 'CPU',
      showNthLabel: 5,
      maxY: 100,
      showLegend: false,
    ...
    //row, col, rowSpan, colSpan, obj, opts
    const net = grid.set(3, 0, 3, 5, sparkline, {
      label: 'Network',
      tags: true,
      style: {
        fg: 'blue',
    ...
    //row, col, rowSpan, colSpan, obj, opts
    const procs = grid.set(3, 7, 3, 5, table, {
      label: 'Processes',
      keys: true,
      interactive: false,
      columnSpacing: 2,
    ...
    //row, col, rowSpan, colSpan, obj, opts
    const temp = grid.set(3, 5, 2, 2, lcd, {
      label: 'Temperature',
      elements: 3,
      display: '00.0C',
      elementPadding: 0,
    ...
    //row, col, rowSpan, colSpan, obj, opts
    const fees = grid.set(8, 0, 3, 3, box, {
      label: 'Fees',
      tags: true,
      style: {
        fg: 'yellow'
    ...
    //row, col, rowSpan, colSpan, obj, opts
    const mempool = grid.set(6, 3, 5, 4, box, {
      label: 'Mempool',
      tags: true,
      style: {
        fg: 'yellow'
    ...
    //row, col, rowSpan, colSpan, obj, opts
    const peers = grid.set(6, 7, 5, 5, table, {
      label: 'Peers',
      keys: true,
      interactive: false,
      columnSpacing: 0,
